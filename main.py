...
class Engine:
    ...
    def __init__(self, *args, **kwargs):
        ...
        if config.USE_CAMERA:
            ...
            self.tabs = (Tab_Stats(self), Tab_Items(self), Tab_Data(self), Tab_Data(self), Tab_Data(self))
        ...
        distortLine = pygame.transform.smoothscale (distortLine, (config.WIDTH, int(distortLineHeight)))
            ...
            if genOverlays:
                if (distortY < config.HEIGHT):
                    ...
                    if config.USE_SCANLINE:
                        ...
                        thisFrame = self.background.convert()
    ...
    def focusInDraw(self, canvas):
        ...
        # Do focusing-in efffooterImgsect by scaling canvas down/up:
        maxDiv = 4
