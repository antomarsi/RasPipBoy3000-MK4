...
class LoadingScene(SceneBase):
    ...
    def __init__(self):
        ...
        self.add_entity("init", InitializeAnimation(), False)
        self.get_entity("intro_anim").on_show()
